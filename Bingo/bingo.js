...
let generateBall = () =>{
    let indexHolder = randomIndexPoolNumbers();                 //This variable hold the random Index to
 ...
 let checkBallinBingoCard = () =>{                               //Checks the ball in the board
     for(let i = 0; i< cardSize; i++){
         for(let j = 0; j< cardSize; j++){
...
let scoreGenerator = () =>{
    let Score = parseInt(1000/turnCounter);
    players.push({Name, Score});
    console.table(players);
}//end function
let offerCard = ()=>{                       //This is a recursive function that keeps offering a card until you are happy
...
window.alert('Everyone starts with 1000 point but the more you take to complete your card the less points you have');
offerCard();
